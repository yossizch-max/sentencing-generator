...
const map={_mashlul:mkEl('67'),has_multiple_yes:mkEl('',true),has_multiple_cond:mkEl('',true,{type:'checkbox'}),has_multiple_disq:mkEl('',true,{type:'checkbox'}),has_multiple_bond:mkEl('',true,{type:'checkbox'}),multi_proc_type:mkEl('consol'),multi_count:mkEl('3'),m_case_1:mkEl('MAIN'),m_case_2:mkEl('JOIN-2'),m_case_3:mkEl('JOIN-3'),cond_case_1:mkEl('C1'),cond_months_1:mkEl('4'),cond_case_3:mkEl('C3'),cond_months_3:mkEl('6'),disq_case_2:mkEl('D2'),disq_months_2:mkEl('12'),bond_case_1:mkEl('B1'),bond_amount_1:mkEl('5000'),bond_case_4:mkEl('B4'),bond_amount_4:mkEl('9000')};
...
if(p.flags.has_multiple_cond!==true||p.flags.has_multiple_disq!==true||p.flags.has_multiple_bond!==true) throw new Error('condition flags');
