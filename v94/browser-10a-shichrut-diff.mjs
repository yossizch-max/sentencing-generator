...
const report={modelEqual:JSON.stringify(a)===JSON.stringify(b),modelDiff:diff(a,b),idDiff,textEqual:g1.text===g2.text,g1Err:g1.err,g2Err:g2.err,len1:g1.text.length,len2:g2.text.length,text1:g1.text,text2:g2.text};
fs.mkdirSync('docs',{recursive:true});
fs.writeFileSync('docs/v94-10a-shichrut-diff.json',JSON.stringify(report,null,2));
console.log(JSON.stringify({modelEqual:report.modelEqual,modelDiff:report.modelDiff.slice(0,30),idDiff:report.idDiff,textEqual:report.textEqual,g1Err:g1.err,g2Err:g2.err,len1:report.len1,len2:report.len2},null,2));
