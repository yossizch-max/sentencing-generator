...
const map={
  ...
  acc_prior_10a:mkEl('',true,{type:'checkbox'}),
  acc_prior_shichrut:mkEl('',false,{type:'checkbox'}),
  acc_agg_crosswalk:mkEl('',true,{type:'checkbox'}),
  acc_agg_speed:mkEl('',true,{type:'checkbox'}),
  acc_mit_self:mkEl('',true,{type:'checkbox'}),
